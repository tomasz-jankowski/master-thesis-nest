...
hoursAvailable:null,i18n:{clear:"Wyczyść",previous:"Poprzedni",next:"Następny",months:"Styczeń Luty Marzec Kwiecień Maj Czerwiec Lipiec Sierpień Wrzesień Październik Listopad Grudzień".split(" "),weekdays:"nie pon wto śro czw pią sob".split(" "),amPm:["am","pm"],hours:"Godzina",minutes:"Minuty",seconds:"Sekundy",unknown:"-",today:"Dziś"},maxDate:null,minDate:null,minutesAvailable:null,minutesIncrement:1,strict:!0,locale:"en",onChange:function(){},secondsAvailable:null,secondsIncrement:1,showWeekNumber:!1,yearRange:25};
